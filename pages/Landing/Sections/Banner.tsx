...
const Banner = () => {
	return (
		<>
			<div id="about" className="h-full bg-white  bg-[url('/images/contact_banner.png')] bg-cover bg-center  text-black w-full flex flex-col gap-5 items-center justify-center md:py-32 py-24">
